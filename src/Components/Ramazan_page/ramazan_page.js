      ...
      <Row className='justify-content-center'>
        ...
        <Col md='10' className='overall-row'>
          ...
          <p className={'text-justify h4'} Style={'padding: 20px'}>
            ...
            15 people who have 90% or above correct answers. However, we are all winners as purpose was to seek
            beneficial knowledge. We have created a{' '}
            <a target='_blank' rel='noopener noreferrer' href='https://chat.whatsapp.com/IFEHh2Ot3NYAIHrtI3Cik7'>
              WhatsApp group
            </a>
            , which you can join if you are interested in Islamic quizzes. Please forward and share it with other
            groups.
          </p>
