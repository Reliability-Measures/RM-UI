...
*/}
        ...
        <Row>
          <Col>
            <div className='card'>
              ...
              <div>
                <h2 className='text-center'>Do you wonder if your..</h2>
                <ul className='text-left font-weight-bold'>
                  <li>
                    Teacher-Made tests data can be digitized for garnering understandings that will help improve your
                    course outcomes?
                  </li>
                  <li>Current assessment technologies are accurately measuring student responses and performance?</li>
                  <li>
                    Vast assortment of test data can be assimilated to provide you with performance trends and insights?
                  </li>
                </ul>
                <a
          ...
          <Col>
            <div className='card'>
              ...
              <div>
                ...
                <Link to='/createquestion' className='btn btn-outline-success text-center' role='button'>
                  Create Item
                </Link>
                <span> </span>
                <Link to='/createquiz' className='btn btn-outline-success text-center' role='button'>
                  Create Quizzes
                </Link>
                <br></br>
                <br></br>
          ...
          <Col>
            <div className='card'>
              ...
              <div>
                <h2 className='text-center'>Manage your classes with fewer clicks...</h2>
                <ul className='text-left font-weight-bold'>
                  <li>Start a new Google class or connect your existing classrooms.</li>
                  <li>
                    Use our platform to create quizzes and exams using questions/items you create or use our Database of
                    questions on different subjects and topics.
                  </li>
                ...
                <button className='btn btn-outline-primary text-center'>Coming Soon!</button>
                <br></br>
                <br></br>
              </div>
            </div>
        ...
        <small className='text-enter'>
          {' '}
          © 2020 Reliability Measures (V {get_config('application_version')}), Contact us: info@reliabilitymeasures.com
          <br></br>
